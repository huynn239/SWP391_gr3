                            ...
                            <div class="tab-pane fade" id="details">
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="images/home/gallery1.jpg" alt="Related Product" />
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=1" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 1 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="images/home/gallery2.jpg" alt="Related Product" />
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=2" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 2 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="images/home/gallery3.jpg" alt="Related Product" />
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=3" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 3 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                <img src="images/home/gallery4.jpg" alt="Related Product" />
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=4" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 4 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=5" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 5 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=6" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 6 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=7" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 7 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=8" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 8 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=9" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 9 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=10" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 10 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=11" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 11 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>$56</h2>
                                                <p>Easy Polo Black Edition</p>
                                                <a href="productDetail.jsp?id=12" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 12 -->
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="item active">	
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="images/home/recommend1.jpg" alt="Recommended Product" />
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="productDetail.jsp?id=13" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 13 -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="images/home/recommend2.jpg" alt="Recommended Product" />
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="productDetail.jsp?id=14" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 14 -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="images/home/recommend3.jpg" alt="Recommended Product" />
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="productDetail.jsp?id=15" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 15 -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    ...
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="productDetail.jsp?id=16" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 16 -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    ...
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="productDetail.jsp?id=17" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 17 -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    ...
                                                    <h2>$56</h2>
                                                    <p>Easy Polo Black Edition</p>
                                                    <a href="productDetail.jsp?id=18" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a> <!-- Giả sử ID là 18 -->
                                                </div>
                                            </div>
                                        </div>
                                    </div>
