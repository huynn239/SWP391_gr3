                        ...
                        <tbody>
                            <c:forEach var="slide" items="${sliders}">
                                <tr>
                                    ...
                                    <td class="text-center align-middle">
                                        <a href="sliderList?action=sliderDetail&id=${slide.id}" class="btn btn-info btn-sm action-btn"><i class="fa fa-eye"></i> Xem</a>
                                        <a href="sliderList?action=editSlider&id=${slide.id}" class="btn btn-warning btn-sm action-btn"><i class="fa fa-edit"></i> Sửa</a>
                                        <a href="sliderList?action=deleteSlider&id=${slide.id}" class="btn btn-danger btn-sm action-btn" onclick="return confirm('Bạn có chắc muốn xóa slider này?');"><i class="fa fa-trash"></i> Xóa</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
